...
小規模な業務管理ツール、WordPress・Webサイトの修正保守、継続サポートを紹介する、**1ページ完結の静的ポートフォリオサイト**です。クラウドソーシングで納品したシフト管理アプリの制作事例と操作デモを中心証拠として掲載しています。
...
| 項目 | 内容 |
|---|---|
| 構成 | プロフィール、納品実績、操作デモ、自主制作、対応可能な業務、お問い合わせ |
